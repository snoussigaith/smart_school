...
import 'package:smart_school/afficherDevoir.dart';
...
class Devoir extends StatelessWidget {
  ...
  Devoir({Key? key}) : super(key: key);

  Future listeDevoir(BuildContext cont) async
  {

    var url  = "http://127.0.0.1/MYEPI/listeDevoir.php";
    ...
    if (data == "success")
    {
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          ...
          builder: (context) => afficherDevoir(filiere: filiere, niveau: niveau,),
        ),
      ...
      Fluttertoast.showToast(msg: "Désolé il n'y pas encore d'anciens devoirs en " + niveau +" "+ filiere ,
              ...
              Container(height: 550, width: double.infinity,
                child: Column(
                  children: [
                    ...
                    const Text("SELECTION DES DEVOIRS", style: TextStyle(
                        color: Colors.black,

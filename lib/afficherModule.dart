...
class afficherModule extends StatelessWidget {
  final String filiere;
  final String niveau;

  const afficherModule({
  ...
  Widget build(BuildContext context) {
    ...
    Future<List> getData() async
    {
      ...
      var url  = "http://127.0.0.1/MYEPI/afficherModule.php";
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Text(list[index]['nomModule'],style: const TextStyle(fontSize: 20,color: Colors.blue,fontWeight: FontWeight.w500),),
                        ...
                        Container(
                          child: InkWell(onTap:() {
                            ...
                            openFile(
                              url : "http://127.0.0.1/MYEPI/PDF/"+list[index]['sourceModule'].toString(),
                              fileName: list[index]['sourceModule'],
                            );

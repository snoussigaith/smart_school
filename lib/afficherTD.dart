...
class afficherTD extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future<List> getData() async
    {
      ...
      var url  = "http://127.0.0.1/MYEPI/afficherTD.php";
            ...
            Card(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(list[index]['nomTD'],style: const TextStyle(fontSize: 20,color: Colors.blue,fontWeight: FontWeight.w500),),
                ...
                Container(
                  child: InkWell(onTap:() {
                    ...
                    openFile(
                      url : "http://127.0.0.1/MYEPI/PDF/"+list[index]['sourceTD'].toString(),
                      fileName: list[index]['sourceTD'],
                    );
